const insults = [
  ...
  "So this big woman with a big ass tells me she's lost 10 pounds... I tell her if she looks behind her, she'll find them",
  "Your mom should've swallowed you. Heard it on the filthy frank show and it's been my favourite comeback ever since.",
...
exports.run = (client, msg, [user]) => msg.channel.send(`${user}, ${insults[Math.floor(Math.random() * insults.length)]}`);
